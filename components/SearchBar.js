...
class Searchbar extends Component {
  ...
  render() {
    return <View style={{ flexDirection: "column", alignItems: "stretch" }}>
        <SearchBar noIcon ref="search" placeholder="Search" style={{ alignSelf: "stretch", fontSize: 50, textAlign: "center" }} onChangeText={text => {
            this.handleTextInputChange(text);
          }} />

        <Icon name="search" onPress={this.handleSubmit} style={{ fontSize: 30, backgroundColor: "#ea2564", textAlign: "center", color: "white", paddingTop: 5, paddingBottom: 5 }} />
      </View>;
  }
}
